...
export default {
  ...
  computed: {
    ...mapGetters({
      isShown: ROOTTYPES.GET_DIALOG_UPDATE_PATIENTS
    }),
  ...
  watch: {
    ...
    detailPatient (val) {
      ...
      this.imageBase64 = this.entry.avatar
      this.previewSrc = this.entry.avatar
    }
  },

  methods: {
    ...mapActions({
      submitData: PATIENTTYPES.UPDATE_DATA_PATIENTS
    }),
